...
class ImageSetsApi(object):
    ...
    def create_image_set_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'main_annotation_type' in params:
            form_params.append(('main_annotation_type', params['main_annotation_type']))  # noqa: E501
        if 'set_tags' in params:
            form_params.append(('set_tags', params['set_tags']))  # noqa: E501
            collection_formats['set_tags'] = 'multi'  # noqa: E501
        if 'team' in params:
    ...
    def create_image_set_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'path', 'location', 'description', 'images', 'product_set', 'main_annotation_type', 'set_tags', 'team', 'creator']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_image_sets(self, **kwargs):  # noqa: E501
    ...
    def partial_update_image_set(self, id, **kwargs):  # noqa: E501
        ...
        :param Body42 body:
        :param str id2: id
        :param str path2: path
        :param str path__contains: path__contains
        :param str name2: name
        :param str name__contains: name__contains
        :param str location2: location
        :param str location__contains: location__contains
        ...
        :param str public: public
        :param str main_annotation_type2: main_annotation_type
        :param str set_tags2: set_tags
        :param str product: product
        :param str collaboration_type: collaboration_type
        :param str priority: priority
        :param str zip_state: zip_state
    ...
    def partial_update_image_set_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'body', 'id2', 'path2', 'path__contains', 'name2', 'name__contains', 'location2', 'location__contains', 'description2', 'description__contains', 'time', 'time__range', 'team2', 'creator2', 'public', 'main_annotation_type2', 'set_tags2', 'product', 'collaboration_type', 'priority', 'zip_state', 'images2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'id2' in params:
            query_params.append(('id', params['id2']))  # noqa: E501
        if 'path2' in params:
            query_params.append(('path', params['path2']))  # noqa: E501
        if 'path__contains' in params:
            query_params.append(('path__contains', params['path__contains']))  # noqa: E501
        if 'name2' in params:
        ...
        if 'name__contains' in params:
            query_params.append(('name__contains', params['name__contains']))  # noqa: E501
        if 'location2' in params:
            query_params.append(('location', params['location2']))  # noqa: E501
        if 'location__contains' in params:
            query_params.append(('location__contains', params['location__contains']))  # noqa: E501
        ...
        if 'public' in params:
            query_params.append(('public', params['public']))  # noqa: E501
        if 'main_annotation_type2' in params:
            query_params.append(('main_annotation_type', params['main_annotation_type2']))  # noqa: E501
        if 'set_tags2' in params:
            query_params.append(('set_tags', params['set_tags2']))  # noqa: E501
        if 'product' in params:
            query_params.append(('product', params['product']))  # noqa: E501
        if 'collaboration_type' in params:
            query_params.append(('collaboration_type', params['collaboration_type']))  # noqa: E501
        ...
        if 'zip_state' in params:
            query_params.append(('zip_state', params['zip_state']))  # noqa: E501
        if 'images2' in params:
            query_params.append(('images', params['images2']))  # noqa: E501
    ...
    def partial_update_image_set_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'name', 'path', 'location', 'description', 'images', 'product_set', 'main_annotation_type', 'set_tags', 'team', 'creator', 'id2', 'path2', 'path__contains', 'name2', 'name__contains', 'location2', 'location__contains', 'description2', 'description__contains', 'time', 'time__range', 'team2', 'creator2', 'public', 'main_annotation_type2', 'set_tags2', 'product', 'collaboration_type', 'priority', 'zip_state', 'images2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
