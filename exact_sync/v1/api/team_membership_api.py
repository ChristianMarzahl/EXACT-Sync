...
class TeamMembershipApi(PaginationBaseAPI):
    ...
    def create_team_membership(self, **kwargs):  # noqa: E501
        """create_team_membership  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_team_membership(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_team_membership_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.create_team_membership_with_http_info(**kwargs)  # noqa: E501
            return data

    def create_team_membership_with_http_info(self, **kwargs):  # noqa: E501
        """create_team_membership  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_team_membership_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_team_membership" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v1/users/team_membership/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_team_membership_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['is_admin', 'team', 'user']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def destroy_team_membership(self, id, **kwargs):  # noqa: E501
        """destroy_team_membership  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.destroy_team_membership(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.destroy_team_membership_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.destroy_team_membership_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def destroy_team_membership_with_http_info(self, id, **kwargs):  # noqa: E501
        """destroy_team_membership  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.destroy_team_membership_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method destroy_team_membership" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `destroy_team_membership`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/users/team_membership/{id}/', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_team_memberships(self, pagination:bool=True, **kwargs):  # noqa: E501
        """list_team_memberships  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_team_memberships(async_req=True)
        >>> result = thread.get()
        ...
        if pagination:
            if kwargs.get('async_req'):
                return self.list_team_memberships_with_http_info(**kwargs)  # noqa: E501
            else:
                (data) = self.list_team_memberships_with_http_info(**kwargs)  # noqa: E501
                return data
        else:
            return self._get_all(self.list_team_memberships_with_http_info, **kwargs)

    def list_team_memberships_with_http_info(self, **kwargs):  # noqa: E501
        """list_team_memberships  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_team_memberships_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_team_memberships" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/v1/users/team_membership/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_team_membership_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/users/team_membership/{id}/', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
